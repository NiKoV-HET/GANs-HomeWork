...
Необходимо было восстановить видео.
...
1. Пробовал восстановить кадры через StableDiffusion, инструментом inpainting, закрашивая часть изображения с маской вручную, в итоге получил следующие результаты:
 ...
 <img src="./StableDiffusionResult/full1.png" alt="alt text" width=450 height="whatever">
 <img src="./StableDiffusionResult/full2.png" alt="alt text" width=450 height="whatever">

 - Восстановление лица и после всего остального \
  <img src="./StableDiffusionResult/part1.png" alt="alt text" width=450 height="whatever">
  <img src="./StableDiffusionResult/part2.png" alt="alt text" width=450 height="whatever">
  <img src="./StableDiffusionResult/part3.png" alt="alt text" width=450 height="whatever">


 - Восстановление отдельных частей лица (глаз) \
  <img src="./StableDiffusionResult/eyes1.png" alt="alt text" width=450 height="whatever">
  <img src="./StableDiffusionResult/eyes2.png" alt="alt text" width=450 height="whatever">

 - Использовать вырезанную часть и восстанавливать части лица постепенно \
<img src="./StableDiffusionResult/step1.png" alt="alt text" width=300 height="whatever">
<img src="./StableDiffusionResult/step2.png" alt="alt text" width=300 height="whatever">
<img src="./StableDiffusionResult/step3.png" alt="alt text" width=300 height="whatever">
<img src="./StableDiffusionResult/step4.png" alt="alt text" width=300 height="whatever">
<img src="./StableDiffusionResult/result1.png" alt="alt text" width=300 height="whatever">
<img src="./StableDiffusionResult/result2.png" alt="alt text" width=300 height="whatever">
